              ...
              <div className={barisTabel()}>
                ...
                <div className="w-2/3">
                  <input
                    ...
                    type="text"
                    className={inputStyle(formErrors.confirm_password)}
                    value={formValue.confirm_password}
                    onChange={handleChange}
                  />
                  <div className={errBaris()}>
                    {formErrors.confirm_password && (
                      <p className={errText()}>{formErrors.confirm_password}</p>
                    )}
                  </div>
                </div>
              </div>
...
export default UserFormCreateAdmin;
