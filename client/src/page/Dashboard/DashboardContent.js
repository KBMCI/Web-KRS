...
function DashboardContent() {
  const { dataMatkul, dataKelas, dataUser } = useContext(DataContext);
  return (
      ...
      <div className="grid gap-5 grid-cols-2">
        <div className="p-6 border border-gray-200 rounded-lg shadow ">
          ...
          <div className="flex justify-center">
            <Button to="/user-panel" name="user-panel" />
          </div>
        </div>
        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow r">
          ...
          <div className="flex justify-center">
            <Button to="/mata-kuliah" name="Mata Kuliah" />
          </div>
        </div>
