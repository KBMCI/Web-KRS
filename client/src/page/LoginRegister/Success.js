...
const Success = (props) => {
  return (
    <div
      className={` z-50 bottom-10 right-10 fixed flex justify-end items-end h-screen  .... ${props.isOpen ? `-translate-x-0` : `right-[-100%] `
      ...
      <div className=" bg-success rounded-2xl text-secondary font-mulis p-4 flex flex-row justify-center items-center w-[370px]">
        <div className="basis-[15%]">
          <img
            src={True}
            alt=""
            className={`${props.isOpen ? `scale-125` : `scale-0`
